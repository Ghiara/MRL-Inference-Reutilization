...
experiment_name = 'cheetah_all_29_08'
    ...
    for episode in range(30000):
        ...
        for batch in tqdm(range(batch_size)):
            ...
            while path_length < max_path_len:
                ...
                r = 0
                # prev_simple_obs = np.array([env.sim.data.qpos[0], env.sim.data.qvel[0]])
...
if __name__ == "__main__":
    ...
    inference_path = '/home/ubuntu/juan/melts/output/toy1d-multi-task/2024_09_14_20_58_59_default_true_gmm'
    ...
    step_predictor = SAC(n_states=env.observation_space.shape[0],
                ...
                hidden_layers_actor = [64,64,64,64],
                hidden_layers_critic = [64,64,64,64],
                memory_size=1e+6,
                batch_size=512,
                gamma=0.9,
                alpha=0.2,
