...
class AntMultiEnv(RandomEnv, utils.EzPickle):
    def __init__(self, *args, **kwargs):
        ...
        RandomEnv.__init__(self, kwargs.get('log_scale_limit', 0), self.model_path, 5, observation_space=observation_space, hfield_mode=kwargs.get('hfield_mode', 'gentle'), rand_params=[])
